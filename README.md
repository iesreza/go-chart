go-chart
========
[![CircleCI](https://circleci.com/gh/iesreza/go-chart.svg?style=svg)](https://circleci.com/gh/iesreza/go-chart) [![Go Report Card](https://goreportcard.com/badge/github.com/iesreza/go-chart)](https://goreportcard.com/report/github.com/iesreza/go-chart)
...
```bash
> go get -u github.com/iesreza/go-chart
```
...
![](https://raw.githubusercontent.com/iesreza/go-chart/master/_images/tvix_ltm.png)

Single axis:

![](https://raw.githubusercontent.com/iesreza/go-chart/master/_images/goog_ltm.png)

Two axis:

![](https://raw.githubusercontent.com/iesreza/go-chart/master/_images/two_axis.png)

# Other Chart Types

Pie Chart:

![](https://raw.githubusercontent.com/iesreza/go-chart/master/_images/pie_chart.png)

The code for this chart can be found in `_examples/pie_chart/main.go`.

Stacked Bar:

![](https://raw.githubusercontent.com/iesreza/go-chart/master/_images/stacked_bar.png)
...
import (
    ...
    "bytes"
    ...
    "github.com/iesreza/go-chart" //exposes "chart"
)
